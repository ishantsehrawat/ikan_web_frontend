...
function EventFinder({ Page }) {
  ...
  return (
    <div
      className={
        Page === "home"
          ? " z-20 drop-shadow-lg backdrop-blur-lg mt-10"
          : " z-20 -mt-10 mx-10 h-full drop-shadow-lg backdrop-blur-lg"
      }
    >
      <div className="px-10 w-auto py-2 md:py-0 md:h-28 bg-white rounded-lg flex flex-wrap justify-between items-center font-bold text-xs md:text-base text-left">
        <div className="flex justify-between w-full md:w-1/2">
          ...
          >
            <p>Location</p>
            <p className="font-normal text-left w-full tracking-widest text-truncate overflow-hidden whitespace-nowrap">
              {locationName}
            </p>
          </button>
          <button
