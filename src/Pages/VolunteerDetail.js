    ...
    return (
        <div className="bg-cgrey">
          <div className=" bg-eventDetail h-1/2 w-full p-10">
            <Navbar Page="volunteer-detail" />
            <div className="mt-28 text-white ml-5">
              <h1 className="text-4xl font-bold mb-3">Volunteer Details</h1>
              <p>
              Welcome to the Volunteer details page. Here you will find all the information you need to know about a specific preson, including Their work, and description.
              </p>
            </div>
          </div>
            ...
            <div className="flex h-72 w-[1100px] justify-center">
              <div className="flex">
                <div className="flex flex-col justify-between">
                  <img className="h-1/3 p-1 " src={volunteer1} alt="event" />
                  <img className="h-1/3 p-1 " src={volunteer1} alt="event" />
                  <img className="h-1/3 p-1 " src={volunteer1} alt="event" />
                </div>
                <img className="p-1" src={volunteer1} alt="event" />
              </div>
              <div className="flex flex-col w-[500px] justify-between ml-5 my-5">
                ...
                <div className="text-sm">
                  ...
                  <p>
                    Share:{" "}
                    <span className="text-gray-500">@XyZ_123</span>
                  </p>
                </div>
              </div>
            </div>
