          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 mt-4">
              <li>
                ...
                that volunteering is a powerful way to build stronger and more
                connected communities.
              </li>
              <li>
                <span className="font-semibold">Empowerment:</span> We empower
                individuals to take action and make a difference in their
                communities.
              </li>
              <li>
                <span className="font-semibold">Inclusion:</span> We strive to
                create a platform that is inclusive and accessible to all.
              </li>
              <li>
                <span className="font-semibold">Support:</span> We are committed
                to providing support and resources to both volunteers and
                non-profit organizations.
              </li>
              <li>
                <span className="font-semibold">Impact:</span> We measure our
                success by the positive impact we make in our communities.
              </li>
            </ul>
          </div>
        </div>
