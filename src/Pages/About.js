...
function About() {
  return (
    <div className="bg-cgrey">
      <div className=" bg-aboutHeader h-[50vh] w-full p-4 md:p-10">
        <Navbar Page="about" />
        <div className="mt-40 text-white ml-5">
          <h1 className="text-4xl font-bold mb-3">About Us</h1>
        </div>
      </div>
      <div className="mx-4 md:mx-36 pt-16">
        <div className="flex flex-col md:flex-row justify-between">
          <div>
            <h1 className="text-xl md:text-4xl font-semibold mb-4">Vision</h1>
          ...
          <div className="mt-10 md:mt-0">
            <h1 className="text-xl md:text-4xl font-semibold mb-4">Mission</h1>
            <p className="w-full md:w-[450px]">
        ...
        <div>
          <h1 className="text-xl md:text-4xl font-semibold mt-10 md:mt-24 mb-4">Goals</h1>
          <p>
        ...
        <div>
          <h1 className="text-xl md:text-4xl font-semibold mt-10 md:mt-24 mb-4">Our Team</h1>
